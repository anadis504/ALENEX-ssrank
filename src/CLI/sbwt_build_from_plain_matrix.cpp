...
int build_from_plain_main(int argc, char** argv) {
  ...
  cxxopts::Options options(
      argv[0], "Construct an SBWT variant from a plain matrix SBWT.");
  ...
  options.add_options()("i,in-file", "Index file of a plain matrix SBWT.",
      ...
      "o,out-file", "Output file for the constructed variant.",
      cxxopts::value<string>())(
      "variant",
      "The SBWT variant to build. Available variants:" + all_variants_string,
      cxxopts::value<string>()->default_value("plain-matrix"))("h,help",
                                                               "Print usage");
